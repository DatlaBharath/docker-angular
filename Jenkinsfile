...
"""
                    ...
                    sh """ssh -i /var/test.pem -o StrictHostKeyChecking=no ubuntu@3.7.248.61 "kubectl apply -f -" < deployment.yaml"""
                    sh """ssh -i /var/test.pem -o StrictHostKeyChecking=no ubuntu@3.7.248.61 "kubectl apply -f -" < service.yaml"""
                }
            }
        }
    }
